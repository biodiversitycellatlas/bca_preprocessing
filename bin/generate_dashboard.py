...
def parse_args() -> argparse.Namespace:
    ...
    # File lists
    parser.add_argument("--star_logs", nargs='*')
    parser.add_argument("--star_summaries", nargs='*')
    parser.add_argument("--star_full_logs", nargs='*')
    parser.add_argument("--mt_rrna_metrics", nargs='*')
    parser.add_argument("--saturation_logs", nargs='*')
    parser.add_argument("--cell_stats", nargs='*')
    parser.add_argument("--af_meta_info", nargs='*')
    parser.add_argument("--af_quant_json", nargs='*')
    parser.add_argument("--af_cell_meta", nargs='*')
    parser.add_argument("--sankey_files", nargs='*')
    parser.add_argument("--per_cell_files", nargs='*')
    parser.add_argument("--saturation_imgs", nargs='*')
    parser.add_argument("--residuals_imgs", nargs='*')
    parser.add_argument("--knee_files", nargs='*')
