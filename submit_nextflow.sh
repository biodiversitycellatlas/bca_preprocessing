...
#SBATCH --job-name nextflow_250414_OAKseq_Nvec
...
nextflow run -resume 973f32b1-3a75-4218-ab77-3743077c3ec4 -profile slurm,250414_OAKseq_Nvec -ansi-log false "$@" & pid=$! 
